...
#anthonys dev version
remotes::install_github("davan690/postcards@shiftr")
```
...
The goal of the package is to make it easy for anyone to create a single page personal website with one R Markdown document. I hope this package can quickly
